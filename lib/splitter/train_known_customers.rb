    ...
    def self.table_sql(opts)
      ...
      %Q{
        ...
        SELECT
          ...
          trn_ng."colors",
          trn_ng."color_returned_times",
          trn_ng."color_bought_times",
          trn_ng."color_returned_ratio",
          trn_ng."size_returned_times",
          trn_ng."size_bought_times",
          trn_ng."size_returned_ratio",
